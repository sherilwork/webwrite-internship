          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 lg:gap-24">
            ...
            <div className="lg:col-span-5 space-y-12">
              <div className="space-y-8">
                <motion.div 
                  ...
                  viewport={{ once: true }}
                  className="group p-8 rounded-[2.5rem] bg-black/[0.01] border border-black/[0.05] hover:bg-black hover:text-white transition-all duration-500"
                >
                  <div className="flex items-center gap-6">
                    <div className="w-14 h-14 rounded-2xl bg-white shadow-sm flex items-center justify-center text-black group-hover:bg-[#f5b800] transition-colors">
                      <Mail className="w-6 h-6" />
                    </div>
                    <div className="space-y-1">
                      <p className="text-[10px] font-black uppercase tracking-widest opacity-40">Email Us</p>
                      <h3 className="text-lg font-black uppercase tracking-tight">info@webwrite.services</h3>
                    </div>
                  </div>
                </motion.div>
                ...
                >
                  <div className="flex items-center gap-6">
                    ...
                    <div className="space-y-1">
                      ...
                      <h3 className="text-lg font-black uppercase tracking-tight">+91-7906627288</h3>
                    </div>
                  </div>
                </motion.div>
                ...
                >
                  <div className="flex items-center gap-6">
                    ...
                    <div className="space-y-1">
                      <p className="text-[10px] font-black uppercase tracking-widest opacity-40">Our Base</p>
                      <h3 className="text-lg font-black uppercase tracking-tight">Uttar Pradesh, India</h3>
                    </div>
                  </div>
                </motion.div>
              </div>
            ...
            <div className="lg:col-span-7">
              <motion.div 
                ...
                viewport={{ once: true }}
                className="p-8 md:p-12 rounded-[3rem] bg-black text-white relative overflow-hidden shadow-2xl"
              >
                ...
                <div className="mb-10 space-y-2">
                  ...
                  <p className="text-xs font-bold uppercase tracking-widest text-white/40">Fill out the form below and we'll reach out shortly.</p>
                </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-8 relative z-10">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    <div className="space-y-2">
                      ...
                      <Input 
                        required 
                        placeholder="John" 
                        className="bg-white/5 border-white/10 h-14 rounded-xl text-white placeholder:text-white/10 focus-visible:ring-[#f5b800] border-none" 
                      />
                    </div>
                    <div className="space-y-2">
                  ...
                  <div className="space-y-2">
                    ...
                    <Textarea 
                      ...
                      className="bg-white/5 border-white/10 min-h-[160px] rounded-2xl text-white placeholder:text-white/10 focus-visible:ring-[#f5b800] border-none resize-none" 
                    />
                  </div>

                  <Button type="submit" className="w-full h-16 rounded-full bg-[#f5b800] text-black text-[12px] font-black uppercase tracking-[0.2em] hover:bg-white transition-all active:scale-95 group">
                    Submit Inquiry
