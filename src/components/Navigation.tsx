    ...
    <header className="fixed top-16 left-0 right-0 z-50 flex justify-center px-4">
      <nav className="flex items-center justify-between w-full max-w-6xl px-4 py-2 bg-white/90 backdrop-blur-md rounded-full border border-border shadow-sm">
        ...
        <Sheet>
          ...
          <SheetContent side="left" className="w-[85%] p-0 flex flex-col bg-white border-r overflow-visible rounded-r-[40px]">
            {/* Custom Side Tab Close Button - Mountain Curve Shape - Scaled Down */}
            <div className="absolute -right-9 bottom-40 z-50">
              <SheetClose asChild>
                <button className="w-9 h-20 bg-white border-l-0 border border-black rounded-r-[24px] shadow-[15px_0_30px_-5px_rgba(0,0,0,0.08)] flex items-center justify-center pr-2.5 pl-0.5 group hover:w-10 transition-all duration-300 ease-in-out">
                  <div className="w-6 h-6 rounded-full bg-[#f5b800]/5 group-hover:bg-[#f5b800]/10 flex items-center justify-center transition-all duration-300">
                    <ChevronLeft className="w-4 h-4 text-[#f5b800] transition-colors" />
                  </div>
                </button>
              </SheetClose>
            </div>
            ...
            <SheetHeader className="pt-16 pb-6 px-6 border-b flex flex-row items-center gap-4 space-y-0 text-left">
              <SheetClose asChild>
                <button className="w-9 h-9 rounded-xl border border-black bg-black/[0.01] flex items-center justify-center hover:bg-[#f5b800]/5 transition-all hover:scale-105 active:scale-95 shrink-0 group">
